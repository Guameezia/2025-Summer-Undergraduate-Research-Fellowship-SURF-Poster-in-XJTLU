...
%{\includegraphics[scale=0.1]{SURF_LOGO.jpg}}
...
\vspace*{-1.5em}
\centering
% {\bfseries \Large \textcolor[RGB]{0,170,255}{Comparative Analysis of SVD Strategies: Auto-k, Fixed k=22, and No-SVD in Classification Tasks}}
...
\draw[line] (svd_denoise.west) -- node[above]{\tiny Yes} ++(-3em,0) -| ++(0,-2em) -- (calc_k.east);
...
% By retaining the top

% $k$ largest singular 

% values, we can appr-

% oximate the original 
